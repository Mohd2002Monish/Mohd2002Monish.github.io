            ...
            s(
              ...
              [
                    ...
                    if (this.config.loop)
                      for (
                        ...
                        var n = this.buildSliderFrameItem(
                          this.innerElements[r].cloneNode(
                            !0
                          )
                        );
                        i.appendChild(n);
                    ...
                    if (this.config.loop)
                      for (
                        ...
                        var a = this.buildSliderFrameItem(
                          this.innerElements[o].cloneNode(
                            !0
                          )
                        );
                        i.appendChild(a);
                ...
                },
                {
                  ...
                  value: function () {
                    if (
                      "number" == typeof this.config.perPage
                    )
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      (e.preventDefault(), this.pointerDown)
                    ) {
                      "A" === e.target.nodeName &&
